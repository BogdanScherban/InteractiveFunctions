...
import { CHART_COS } from "../constants/lineTypes";
...
const defaultLinesArray = getDefaultLinesArray(CHART_COS);
...
const CurrentFormula = ({ formula }) => {
    return <span>y = cos(x)</span>;
};


class CosChart extends Component  {
    ...
    cleanChart = () => {
        this.setState({
            ...
            linesArray: getDefaultLinesArray(CHART_COS),
            disabledLines: [],
        });
    };
...
export default withStyles(styles)(CosChart);
